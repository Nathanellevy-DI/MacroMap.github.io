...
export default function RewardCalendar({ history, budget, onDateSelect }: RewardCalendarProps) {
    ...
    const getDayColor = (day: number) => {
        ...
        if (!dayData || dayData.consumed === 0) return 'bg-gray-100 text-gray-400';
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="pt-4 border-t border-gray-100">
                <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">Days logged this month</span>
                    <span className="font-bold text-emerald-500">{monthlyDays} days</span>
                </div>
            </div>
